...
project = 'mauzr'
copyright = '2017, Alexander Sowitzki'
...
latex_documents = [
    (master_doc, 'mauzr.tex', 'mauzr Documentation',
     'Alexander Sowitzki', 'manual'),
]
...
man_pages = [
    (master_doc, 'mauzr', 'mauzr Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'mauzr', 'mauzr Documentation',
     author, 'mauzr', 'A framework for CPS.',
     'Miscellaneous'),
]
